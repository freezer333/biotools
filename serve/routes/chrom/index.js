...
exports.routes.get("/chrom", function(req, res) {
...
exports.routes.get("/chrom/locusmap/:accession/:locus", function(req, res) {
...
exports.routes.get("/chrom/:accession/:start/:end", function(req, res) {
  var accession = req.params.accession;
  ...
  db.getSequence(accession, start, end, function(err, result) {
    if (err) {
      res
        .status(404)
        .end(
          "Sequence range on chromosome " + accession + " could not be found"
        );
    } else {
